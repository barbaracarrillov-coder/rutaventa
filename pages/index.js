...
function Prospects({clients,addClient}){const[q,setQ]=useState("");const[loc,setLoc]=useState("");const[results,setResults]=useState([]);const[ld,setLd]=useState(false);const[searched,setSearched]=useState(false);
  ...
  return(<div style={{animation:"fadeIn 0.4s"}}><h2 style={{fontSize:"22px",fontWeight:900,marginBottom:"4px"}}>Buscar Prospectos</h2><p style={{fontSize:"14px",color:"#64748b",marginBottom:"14px"}}>Negocios reales cerca de tu ubicación</p>
